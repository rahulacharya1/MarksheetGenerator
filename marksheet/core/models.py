...
class School(models.Model):
    ...
    BOARD_CHOICES = (('CBSE','CBSE'),('ICSE','ICSE'),('STATE','State Board'),('IB','IB'),('IGCSE','IGCSE'))
    ...
    registration_certificate = models.FileField(upload_to='school_documents/', null=True, blank=True)
...
class Exam(models.Model):
    ...
    classes = models.ManyToManyField(ClassRoom, related_name="exams")
